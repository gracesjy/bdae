### Python All Output in One Dataframe.
...
def display():
    ...
    f = open('/home/oracle/Pictures/kohonen03.jpg', mode="rb")
    image_data = f.read()
...
```
![MODEL_OUTPUT1.png](../../images/MODEL_OUTPUT1.png)
![MODEL_OUTPUT2.png](../../images/MODEL_OUTPUT2.png)
